...
# ########
# 
# pwd = 'H:/Unidades compartidas/TF-Andres/Reshapes/Dodecano_Heptano/Lin/'
# 
# S = pd.read_csv(pwd+"Transformada.txt", header=None).to_numpy()
...
# ax.set_yscale('log')
# plt.tick_params(axis='both', which='major', labelsize=10)
# #plt.savefig(pwdd+"Resh_HeptDode_Lin_NOLineas", dpi=600)
# plt.show()
# =============================================================================
...
plt.tick_params(axis='both', which='major', labelsize=10)
#plt.savefig(pwdd+"Mapa_T1D_HeptDode_Separados", dpi=600)
plt.show()
